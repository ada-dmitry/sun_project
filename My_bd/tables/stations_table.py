...
# класс человек:
#     атрибуты(имя, фамилия, возраст)
#     методы(пукнуть, моргнуть)

# класс женщина(человек):
#     атрибуты(размер груди)
#     методы(краситься, купить бюстгалтер)

#     def buy_lifchik(self, size):
#         пойти в магазин и купить лифчик размер size

# Катя = женщина(Катя, Ускова, 19, 3-4)

# Саша = женщина(Саша, Антипенко, 14, 1)

# катя.купить бюстгалтер()
# саша.купить бюстгалтер()
